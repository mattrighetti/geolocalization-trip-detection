...
def detect_vehicle_and_km(app, user_route: list):
...
def elaborate_request(app,user_id, ticket_id, start_time, end_time, data):
    ...
    vehicle, km_travelled = detect_vehicle_and_km(app,data)
